    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        <View style={styles.containerForm}>
          {['Serial', 'Descripción', 'Código de Ambiente', 'ID Categoría', 'Estado del Objeto', 'Observaciones del Objeto', 'Tipo de Objeto', 'Marca del Objeto', 'Valor del Objeto'].map((label) => (
